-- Simplify the activity feed function to fix structure mismatch
-- This creates a simpler version that should work without type conflicts
...
BEGIN
    ...
    SELECT 
        ...
        pa.is_milestone,
        pa.created_at,
        COALESCE(users.name, users.email)::VARCHAR(255) as user_name,
        users.avatar_url::VARCHAR(500) as user_avatar,
        at.display_name::VARCHAR(100) as type_display_name,
        at.icon::VARCHAR(20) as type_icon,
        at.color::VARCHAR(20) as type_color,
